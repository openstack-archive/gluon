...
POLICY_OPTS = [
    cfg.StrOpt('policy_file',
               ...
               help=("file path to the policy_file. Gluon medels define policies in "
                     "their corresponding yaml files and in most cases users should "
                     "manage policies e.g. create, update, delete within the yaml files "
                     "thus making the yaml files as the single reference for model definitions. " 
                     "This file is provided as an avaiable option for users to add new "
                     "or modify existing policies")),
]
