...
development of Gluon and a propsed structure going forward.
...
- **gluon**
  ...
  - gluon-server code
    ...
    - Uses particle generator to generate the REST API from model files  
      (like a proton)
    - Uses particle generator to generate sqlalchemy database classes from 
  ...
  - gluonclient code
    ...
    - Main entry point for CLI script
      ...
      - Contains custom extensions for bind/unbind operations (i.e. not 
        generated)
