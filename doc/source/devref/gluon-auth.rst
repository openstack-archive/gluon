...
configuration is shown below. Change 127.0.0.1 to your keystone server ip. 
...
Appendix
--------
Configuring identity details for Keystone, change 10.0.0.2 to your gluon server ip:
